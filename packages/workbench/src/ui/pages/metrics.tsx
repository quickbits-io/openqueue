    ...
    <div className="divide-y divide-border">
      {jobs.map((job, index) => (
        <button
          ...
          type="button"
          onClick={() => onJobSelect(job.queueName, job.jobId)}
          className="flex w-full items-center justify-between bg-transparent px-4 py-2.5 text-left hover:bg-muted/30"
        >
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="border border-dashed bg-card">
          ...
          <SlowestJobsTable jobs={slowestJobs} onJobSelect={onJobSelect} />
        </div>
